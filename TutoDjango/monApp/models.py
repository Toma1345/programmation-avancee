...
class Produit(models.Model):
    ...
    dateFab = models.DateField(default=date.today)
    ...
    # Un produit à un statut
    statut = models.ForeignKey(Statut, on_delete=models.CASCADE, related_name="produitStatut",null=True, blank=True)
