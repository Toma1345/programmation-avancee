...
urlpatterns = [
    ...
    path("rayon/<pk>/cntnr/<contenir_pk>/update/", views.ContenirUpdateView.as_view(), name='cntnr-updt'),
    path("rayon/<pk>/cntnr/<contenir_pk>/delete/", views.ContenirDeleteView.as_view(), name='cntnr-sup'),
